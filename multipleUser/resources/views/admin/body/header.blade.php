<nav class="navbar">
              ...
              <div class="input-group-text">
                ...
                <a href="javascript:;" class="dropdown-item py-2"><i class="flag-icon flag-icon-bd" title="bd" id="bd"></i><span class="ms-1"> Bangla </span></a>
							...
							<div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
								<div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
									...
									<div class="text-center">
										<p class="tx-16 fw-bolder">Adrita Rahman</p>
										<p class="tx-12 text-muted">adritarahman@gmail.com</p>
									</div>
								</div>
